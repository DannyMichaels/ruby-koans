...
class AboutSymbols < Neo::Koan
  ...
  def test_method_names_become_symbols
    symbols_as_strings = Symbol.all_symbols.map { |x| x.to_s }  #to_s means to string.
  ...
  in_ruby_version("mri") do
    ...
    def test_constants_become_symbols
      all_symbols_as_strings = Symbol.all_symbols.map { |x| x.to_s } #ask about this behaviour
  ...
  def test_symbols_cannot_be_concatenated
    ...
    assert_raise(NoMethodError) do #ask about this
      :cats + :dogs
    end
  end
