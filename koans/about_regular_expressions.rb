...
class AboutRegularExpressions < Neo::Koan
  ...
  def test_plus_means_one_or_more
    assert_equal "bccc", "abbcccddddeeeee"[/bc+/] #review this behaviour
  end
  ...
  #irb(main):146:0> "one two-three".sub(/(t\w*)/) { $1[0, 1] }
# => "one t-three"
# irb(main):147:0> "one two-three".sub(/(t\w*)/) { $1[1, 1] }
# => "one w-three"
# irb(main):148:0> "one two-three".sub(/(t\w*)/) { $1[2, 1] }
# => "one o-three"
...
# irb(main):150:0> "one two-three".gsub(/(t\w*)/) { $1[0, 1] }
# => "one t-t"
# irb(main):151:0> "one two-three".gsub(/(t\w*)/) { $1[1, 1] }
# => "one w-h"
# irb(main):152:0> "one two-three".gsub(/(t\w*)/) { $1[3, 1] }
# => "one -e"